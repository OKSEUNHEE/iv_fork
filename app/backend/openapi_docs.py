...
TAG_DESCRIPTIONS = [
    ...
    {"name": "RAG", "description": "Qdrant에 색인된 학습 문서의 유사도 검색 API입니다. 생성형 답변이 아니라 관련 문서 청크를 반환합니다."},
...
OPERATION_DOCS: dict[str, tuple[str, str, str]] = {
    ...
    "/api/rag/ask": ("RAG", "관련 학습 문서 찾기", "생성 모델을 호출하지 않고 질문과 연관된 문서 청크·출처를 반환합니다. Qdrant가 준비되지 않으면 503입니다."),
