...
const routes = {
  ...
  'today-gainers':    { label: '섹터별 대표 종목',            render: () => todayGainersView(app) },
...
const PRACTICE_GUIDES = {
  ...
  'financial-statement': {
    ...
    text: '회사가 번 돈, 가진 것, 갚아야 할 돈을 연결해 읽고, 유동·유형·무형·투자자산이 현금·설비·기술·금융투자 위험에 어떻게 이어지는지 살펴봅니다. 가계부에서 수입·지출·통장을 함께 보는 것과 비슷합니다.',
  },
  'valuation': {
