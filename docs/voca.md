...
## 리테일 투자자와 Equity: 시장에서 누가 무엇을 거래하나요?

**리테일 투자자(Retail Investor)**는 증권사·자산운용사·연기금 같은 전문 금융기관이 아닌 **개인 투자자**를 말해요. 국내에서는 흔히 ‘개미 투자자’라고도 부릅니다. 보통 개인의 저축이나 자본으로 HTS·MTS를 이용해 직접 거래하며, 기관에 비해 거래 규모가 작은 경우가 많습니다. 개인마다 정보 접근성·분석 경험·투자 기간은 다르므로, ‘리테일 투자자’라는 분류만으로 판단이나 성과를 일반화할 수는 없어요.

**Equity(에쿼티)**의 핵심 뜻은 **소유권에 해당하는 지분** 또는 **자기자본**이에요. 쓰이는 맥락에 따라 다음처럼 구분합니다.

| 쓰이는 맥락 | Equity의 뜻 | 예시 |
| --- | --- | --- |
| 주식시장 | 기업의 소유권을 나타내는 주식·지분 | “Equity 시장에 투자한다”는 보통 주식시장에 투자한다는 뜻이에요. |
| 기업 재무 | 자산에서 부채를 뺀 주주 몫, 즉 자기자본 | `자산 - 부채 = 자기자본(Equity)` |
| 부동산·기업 인수 등 대체투자 | 대출(Debt)을 제외하고 투자자가 직접 넣은 자본 | 매입 자금 중 은행 대출이 아닌 투자자 출자금 |

| 구분 | 리테일 투자자 | 기관 투자자 |
| --- | --- | --- |
| 주체 | 개인 투자자 | 연기금, 자산운용사, 은행, 사모펀드 등 |
| 자금 출처 | 개인의 저축·자본 | 고객 위탁자금, 펀드 자금, 연기금 등 |
| 주된 투자 방식 예시 | 상장주식 직접 매수, ETF 매수 | 대량 매매, 블록딜, 기관용 펀드·PEF 투자 등 |

기업은 주식을 발행해 Equity 자금을 조달할 수 있고, 리테일 투자자는 그 주식을 사서 주주가 됩니다. 주주는 기업의 성과에 따라 배당을 받을 수 있고 주가 변동에 따른 손익을 경험할 수 있지만, 배당과 주가 상승은 보장되지 않아요.
...
| 자본금 | Paid-in Capital / Capital Stock | 주식을 발행할 때 액면가 기준으로 기록되는 자본이에요. 회사가 실제로 가진 현금이나 현재 시가총액과 항상 같지는 않아요. |
| 자본잉여금 | Capital Surplus | 주식 발행가가 액면가보다 높을 때의 주식발행초과금처럼, 주주와의 자본거래에서 생긴 자본이에요. 영업으로 번 이익이나 바로 쓸 수 있는 현금과는 달라요. |
| 이익잉여금 | Retained Earnings | 회사가 영업·투자 활동으로 번 이익에서 배당 등을 한 뒤 회사 안에 누적된 부분이에요. 자본잉여금과 달리 사업 성과가 쌓이며 변해요. |
| 유동자산 | Current Assets / 流動資産 | 보통 1년 또는 정상 영업주기 안에 현금화·판매·사용될 것으로 기대하는 자산이에요. 현금, 매출채권, 재고자산 등이 대표적이며 유동부채와 함께 단기 지급 능력을 봐요. |
| 당좌자산 | Quick Assets / 當座資産 | 유동자산 중 재고 판매를 기다리지 않고 비교적 빨리 현금화하거나 지급에 쓸 수 있는 항목을 묶어 보는 분류예요. 현금및현금성자산, 단기금융상품, 매출채권 등이 들어갈 수 있지만, 공시별 포함 항목은 확인해야 해요. |
| 현금및현금성자산 | Cash and Cash Equivalents | 현금, 요구불예금과 취득 시점에 만기가 매우 짧고 가치 변동 위험이 작은 투자예요. 단기금융상품이라도 만기·위험·사용 제한에 따라 현금성자산과 다르게 표시될 수 있어요. |
| 재고자산 | Inventory | 판매할 물건, 생산 중인 물건, 생산에 쓸 재료예요. 제조업은 보통 원재료→재공품→제품(완제품)으로, 유통업은 사 와서 되파는 상품으로 나눠 봐요. 재고가 매출보다 오래 쌓이면 할인·폐기·평가손실 위험을 확인해요. |
| 투자자산 | Investment Assets | 이자·배당·가격 상승 또는 전략적 관계를 기대하며 보유하는 자산을 넓게 부르는 말이에요. 실제 공시에서는 금융자산, 장기금융자산, 관계기업투자, 투자부동산 등으로 나뉘어 표시될 수 있어 보유 목적과 주석을 확인해야 해요. |
| 관계기업투자·지분법 | Investment in Associates / Equity Method | 투자회사가 다른 회사에 중요한 영향력을 행사할 수 있을 때 쓰일 수 있는 투자와 회계 방법이에요. 단순히 받은 배당만 보는 대신 피투자회사 이익·손실 중 투자 지분만큼이 반영될 수 있어요. |
| 투자부동산 | Investment Property | 제품을 만들거나 사무실로 직접 쓰기보다 임대료나 시세 차익을 목적으로 보유한 토지·건물이에요. 본업에 쓰는 유형자산과 목적이 달라 공실·임대수익·가격 변동을 따로 봐요. |
| 유형자산 | Property, Plant and Equipment (PPE) / 有形資産 | 공장, 건물, 기계, 서버처럼 형태가 있고 여러 해 쓰는 자산이에요. 사들일 때 현금이 나가고, 보통 사용 기간에 걸쳐 감가상각비가 비용으로 반영돼요. |
| 무형자산 | Intangible Assets / 無形資産 | 특허권, 상표권, 소프트웨어, 라이선스처럼 형태는 없지만 회사가 통제하는 권리·자산이에요. 회계 기준에 따라 상각하거나 가치 하락 때 손상차손을 반영할 수 있고, 내부 브랜드·아이디어가 모두 장부에 잡히는 것은 아니에요. |
