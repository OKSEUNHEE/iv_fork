...
| 호가 | 呼價 / Quote, Bid, Ask | `呼`는 부르다, `價`는 값이에요. 영어 `quote`도 제시한 가격이라는 뜻이에요. | “10,000원에 사겠습니다/팔겠습니다”라고 부르는 가격이에요. 사겠다는 가격은 `bid`, 팔겠다는 가격은 `ask`라고도 해요. |
...
| 주당순이익(EPS) | 당기순이익 ÷ 발행주식 수 | 일회성 이익인지, 보통주 기준인지도 확인해요. |
...
| 시가·고가·저가·종가 | Open·High·Low·Close (OHLC) / 始價·高價·低價·終價 | 장이 열릴 때 가격, 가장 높았던 가격, 가장 낮았던 가격, 장이 끝날 때 가격이에요. 차트의 기본 재료예요. |
...
| 상한가·하한가 | Upper·Lower Price Limit / 上限價·下限價 | 하루에 오르거나 내릴 수 있는 가격 범위의 끝을 말해요. 정확한 기준과 예외는 거래소 규정을 확인해야 해요. |
