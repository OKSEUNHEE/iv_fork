...
m7  - M7과 **MANGOS(망고스)**는 개별 기업의 이름이 아니라, **미국 뉴욕 증시를 이끄는 거대 빅테크 기업들을 묶어서 부르는 투자 용어(신조어)**입니다.
​질문하신 두 용어에 포함된 기업들은 다음과 같습니다.
​1. M7 (Magnificent 7)
...
​요약하자면:
"M7이나 망고스라는 이름의 회사가 있는 것이 아니라, 미국 주식시장에서 가장 잘나가는 메타, 엔비디아, 구글, 오픈AI, 스페이스X 같은 초거대 테크 기업들을 묶어서 부르는 별명이라고 생각하시면 됩니다."
